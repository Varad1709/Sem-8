        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($stmt) {
                ...
                if ($stmt->execute()) {
                    ...
                    // header("Refresh:10; url=edit.php?user_id=$id&query_id=$idq&emp_id=$emp_id");
                    header("Refresh:2; url=edit.php?user_id=$id&query_id=$idq&emp_id=$emp_id&name=$name" . (isset($selected_month) ? "&month=$selected_month" : ""));
                    exit();
                } else {
...
<div class="dashboard">
    ...
    <a href="follow_up.php?month=<?php echo isset($_GET['month']) ? $_GET['month'] : ''; ?>&emp_id=<?php echo $emp_id; ?>&user_id=<?php echo $id; ?>&query_id=<?php echo $idq; ?>">Complaints</a>
...
<br>
<br>
<button class="back-button" onclick="window.location.href='follow_up.php<?php if (!empty($selected_month)) echo "?month=$selected_month"; ?><?php if (empty($selected_month)) echo "?month="; ?><?php if (!empty($emp_id)) echo "&emp_id=$emp_id"; ?>'">Back</button>

<div class="container">
    <h2>Edit Inquiry</h2>
    <form action="<?php echo $_SERVER["PHP_SELF"] . "?user_id=$id&query_id=$idq&emp_id=$emp_id"; ?>" method="post">
